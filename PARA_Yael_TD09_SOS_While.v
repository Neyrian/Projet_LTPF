...
J'ai acquis les bases de ce qui est attendu : preuve avec SOS_again et SOS_stop *) 
...
Proof.
  ...
  eapply SOS_again.
  { apply SOS_Seqf. cbn. apply SOS_Assign. }
  eapply SOS_again.
  { apply SOS_While. }
  eapply SOS_again.
  { apply SOS_If_true. cbn. reflexivity. }
...
(** Réutiliser les lemmes précédents *)  
...
Proof.
  ...
  eapply SOS_again. cbv[Pcarre]. cbv[invar_cc].
  { apply SOS_While. }
  eapply SOS_again. Compute (evalB (Bnot (Beqnat Ir (Aco n)))) [i; i * i; S (i + i)]. (*no lo se*)
  { apply SOS_If_true. cbn. rewrite eq. cbn[negb]. reflexivity. }
  eapply SOS_again. cbv[corps_carre].
  { apply SOS_Seqi. apply SOS_Seqf. apply SOS_Assign. }
  eapply SOS_again.
  { apply SOS_Seqi. apply SOS_Seqf. apply SOS_Assign. }
  eapply SOS_again.
